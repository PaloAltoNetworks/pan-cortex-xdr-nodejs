 ...
 * once.
 */
async function deleteEndpoint(filters) {
    const payload = {
        request_data: { filters }
    };
    const { data, status } = await this.session.post(api_endpoint_1.deleteEndpointPath, api_endpoint_1.endpointApiErrBldr, payload);
