 ...
 */
async function unisolateEndpoint(criteria) {
    let payload;
    ...
    const { data, status } = await this.session.post(api_endpoint_1.unisolateEndpointPath, api_endpoint_1.endpointApiErrBldr, payload);
    if (typeof data == 'string')
        throw new xdrerror_1.XdrError('endpoint', data, status);
    return data;
}
exports.unisolateEndpoint = unisolateEndpoint;
