...
import { basicXdrApiKey, advXdrApiKey } from '..'
...
describe('headers', function () {
    it('basic api key', function () {
        const headers = basicXdrApiKey(apiKey, apiKeyId).headers()
    ...
    it('advanced api key', function () {
        const headers = advXdrApiKey(apiKey, apiKeyId).headers({ nonce: preNonce, ts: preTs })
